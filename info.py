...
DATABASE_NAME = environ.get('DATABASE_NAME', "SadieBot")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Mindflayers_Mirror')
...
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", "<code>{file_name}</code>\n\n<b>Size:</b> {file_size}\n\n<b>Join [VECNA BOT](https://t.me/vecna_mirrorbot) for more Movies </b>")
